  ...
  export default {
    ...
    methods: {
      ...
      postDepartments(){
        if(this.addBusinessUser.id){
          businessNamesUpdate({
            ...
            sortNum: this.addBusinessUser.sortNum,
      ...
      edit(item) {
        ...
        this.addBusinessUser.sortNum = item.sortNum.toString()
        this.addBusinessTitle = '编辑 / 业务名称'
        this.addBusinessModal = true;
      },
    },
		created() {},
