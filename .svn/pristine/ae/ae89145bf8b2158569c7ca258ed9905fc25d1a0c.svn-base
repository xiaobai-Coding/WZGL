<template>
    <div class="v-clock">
        <Card>
          ...
          <Row  style="display: flex;flex-direction: row;margin-top: 1%;width: 100%;height: calc(50%-50)!important;">

            <i-col style="display: flex;flex-direction: column;width: 75%;height: 100%;">
              <!-- 左边上半部分-->
              <div style="display: flex;width: 100%;height:20%;padding: 10px;justify-content: space-between;align-items: center;background-color: #ffffff;">
                <div class="divBox" :style="{background: colors[index],height:'90%'}" v-for="(item,index) in countList" v-bind:key="index">
              ...
              <!-- 左边下半部分-->
              <div style="padding: 10px;background-color: #ffffff;margin-top: 1%;height:80%;">
                <Tabs value="name1">
                ...
                <div style="display: flex;flex-direction: column;width: 100%;height:calc(100%-60)!important;">
                  <div style="display: flex;height: 1%;">
                    <div style="width:70%;font-weight: bold;font-size: 16px;"><span>入库笔数趋势</span></div>
                    <div style="width: 2%;"></div>
                    <div style="width:28%;margin-left: 10px;font-weight: bold;font-size: 16px;"><span>采购数量排名</span></div>
                  </div>
                  <div style="display: flex;flex-direction: row;height:calc(99%-60)!important;width: 100%;">
                    <div id="bar-chart" style="width:70%;height:{tabheight1};"></div>
                    <div :style="{background: '#eeeeee',width:'1%',height:tabheight1}"></div>
                    <div style="width:29%;height: 100%!important;margin-left: 20px;">
                      <Table border  :columns="column" :data="rankList" :height='tabheight1'></Table>
                    </div>
                  </div>
                </div>
            ...
            <!-- 右边-->
            <i-col span="7" style="display: flex;flex-direction: column;background-color: #ffffff;width:24%;margin-left: 1%;">
              <div style="display: flex;justify-content: center;padding: 10px;font-weight: bold;font-size: 16px;width: 100%;"><span>物资总数</span></div>
              <div id="dashboard-chart" style="height:100%!important;padding-top: 5%;"></div>
              <div id="funnel-chart" style="height:100%!important;padding-top: 5%;"></div>
            </i-col>
          </Row>

         <div style="padding: 10px;background-color: #ffffff;margin-top:1%;">
            <Tabs value="name1">
                    <TabPane label="物资采购" name="name1"></TabPane>
                    <TabPane label="物品入库" name="name2"></TabPane>
                    <TabPane label="物资领用" name="name3"></TabPane>
              ...
              <div style="display: flex;flex-direction: row;width: 100%;">
                <Table border  :columns="column2" :data="rankList" :height="tabheight2" :width='tabWidth2'></Table>
              </div>
    ...
    export default {
        ...
        data() {
            return {
              ...
              tabheight1:window.innerHeight*0.45-180,

              tabheight2:window.innerHeight*0.50-220,
              tabWidth2:window.innerWidth,
            }
        },
        computed: {},
        watch: {},
...
<style scoped lang="less">
    ...
    .divBox{
      background-color: aqua;display: flex;flex-direction: column;justify-content: center;align-items: center;width: 150px;height: 100%;
