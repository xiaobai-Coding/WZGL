  ...
  <div class="v-clock">
    <Form class="addAccountUser" ref="addBusinessUser" :model="addBusinessUser" :label-width="100" :rules="ruleInline">
      <div>
        ...
        <FormItem label="排序码:" prop="sortNum">
          <Input type="text"  v-model="addBusinessUser.sortNum" placeholder="请输入部门序号">
          </Input>
        </FormItem>
      </div>
      <div>
        <FormItem label="是否启用:">
          <Select v-model="addBusinessUser.enable" placeholder="请选择部门状态">
      ...
      <div>
        <FormItem label="备注">
          <Input
            v-model="addBusinessUser.remarks"
            type="textarea"
