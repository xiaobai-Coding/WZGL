          ...
          getIndex(page){
            let data = {
              ...
              if(this.search.company != ''){
                data.company = this.search.company
              }
              if(this.search.startDate != ''){
                data.startDate = this.search.startDate
              }
              if(this.search.endDate != ''){
                data.endDate = this.search.endDate
              }
              if(this.search.systemName != ''){
                data.systemName = this.search.systemName
              }
              if(this.search.organization != ''){
                data.organization = this.search.organization
              }
