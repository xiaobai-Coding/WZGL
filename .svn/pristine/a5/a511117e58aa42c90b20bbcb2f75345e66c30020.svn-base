...
ucMenu.wareHouse = {
  ...
  nav: [
    ...
    },
    {
      ...
      role:[],
      firstLayerNav:[
        {icon: '', name: '物品类别', url: 'GoodsCategoryIndex',role:[5]},
        {icon: '', name: '计量单位', url: 'UnitMeasureIndex',role:[]},
        {icon: '', name: '供应商类别', url: 'SupplierCategoryIndex',role:[]},
        {icon: '', name: '供货单位', url: 'SupplierCompanyIndex',role:[]},
        {icon: '', name: '仓库配置', url: 'WareHouseConfigIndex',role:[]},
        {icon: '', name: '物品管理', url: 'GoodsManageIndex',role:[]},
      ],//基础数据
    },
    {
      icon: 'md-stats',
      ...
      firstLayerNav:[
        ...
        {icon: '', name: '入库管理', url: 'EquipmentManage',role:[]},
        {icon: '', name: '出库管理', url: 'EquipmentManage',role:[]},
        {icon: '', name: '仓库盘点', url: 'EquipmentManage',role:[]},
        {icon: '', name: '资产台账', url: 'EquipmentManage',role:[]},
      ],//管理维护
    },
  ],
}
